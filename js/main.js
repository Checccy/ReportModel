        ...
        var PRINTMODEL={"PaperInfo":{"type":"A4","size":{"width":210,"height":297,"isDefault":true}},"ControlList":[{"type":"Hospital","top":"6mm","left":"81mm","topNum":6,"leftNum":81,"width":40,"height":5,"text":"医院名称","example":"上海同济医院微生物报告"},{"type":"Hospital","top":"18mm","left":"10mm","topNum":18,"leftNum":10,"width":40,"height":5,"text":"医院名称","example":"上海同济医院微生物报告"},{"type":"RecordId","top":"18mm","left":"64mm","topNum":18,"leftNum":64,"width":29,"height":5,"text":"记录单号","example":"记录单号：56959"},{"type":"ReportDate","top":"18mm","left":"124mm","topNum":18,"leftNum":124,"width":49,"height":5,"text":"报告时间","example":"报告时间：2016-03-02 00:00:00"},{"type":"AntibioticResult","top":"30mm","left":"10mm","topNum":30,"leftNum":10,"width":190,"height":33,"text":"细菌药敏结果","example":"细菌药敏结果"}],"PrintType":"ReportControl"};
        ...
        var PrintModelGenerator={
            generateModel:function(printModel,canvasId){
                if (printModel.ControlList.length>0) {
                    var _canvas=Common.getItself(canvasId);
                    Canvas.changePaper.call(_canvas,printModel.PaperInfo.type)
                    var canvasArea=Canvas.area.call(_canvas);
                    var controlList=ControlLibrary[printModel.PrintType];
                    $("#PrintType").val(printModel.PrintType);
                    ControlGenerate.generate(controlList,'ControlContainer',canvasId);
